...
import { Dimensions, FlatList, Image, StyleSheet, TouchableOpacity, Animated as Ani, Pressable } from 'react-native'
...
const Page = () => {
  const {cartList, addToCart, deleteFromCart} = useCartStore();
                ...
                <View style={{ flex: 1, paddingLeft: 10 }}>
                  ...
                  <View style={{flexDirection: "row", justifyContent: "space-between"}}>
                    <Text style={{  fontFamily: "medium", fontSize: 20}}>
                      ...
                      <TouchableOpacity style={{ borderColor: "#808080", borderWidth: 1, width: 30, height: 30, justifyContent: "center", alignItems: "center" }}>
                          <Text style={{ textAlign: "center" }}>
                            <AntDesign name="minus" size={24}  />
                          </Text>
                        </TouchableOpacity>
                       
                        <View  style={{ borderColor: "#808080", borderWidth: 1, width: 30, height: 30, justifyContent: "center", alignItems: "center" }}>

import { Appearance, Pressable, SafeAreaView, StyleSheet, TouchableOpacity } from 'react-native'
  ...
  return (
    <SafeAreaView style={defaultStyles.container}>
      <View style={{ marginTop: 50, padding: 10, flex: 1}}>
        ...
        <View style={{ marginVertical: 20, backgroundColor: "#ddd", paddingVertical: 10, paddingHorizontal: 20, borderRadius: 10, width: "100%", flexDirection: "row", alignItems: "center", gap: 10}}>
        ...
        <View style={{ flexDirection: "row", borderBottomColor: "#ddd", borderBottomWidth: 0.5, paddingBottom: 25,  justifyContent: "space-between", marginTop: 20}}>
          <View>
        ...
        <View style={{ flexDirection: "row", alignItems: "center", borderBottomColor: "#ddd", borderBottomWidth: 0.5, paddingBottom: 25,  justifyContent: "space-between", marginTop: 20}}>
          <View>
